# SOYO Tam Otomatik v2.4

Bu sürüm, gönderilen **Önerilen** ve **Murat sohbet** ekran görüntülerindeki düzene göre ayarlandı.

## Akış

1. Bir kez Android **Ayarlar → Erişilebilirlik → SOYO Tam Otomatik** servisini aç.
...
7. Mesaj kutusu doğrulandıktan sonra gönder düğmesine otomatik olarak yalnızca bir kez basılır.
8. Manuel onay yoktur; servis açıksa mesajı otomatik olarak tek kez gönderir, listeye geri döner, sıradaki kişiyi açar; görünür uygun kişi kalmadığında listeyi ileri kaydırır.
...
10. Tam Otomatik Mod sabittir; ayrı aç/kapa kutusu kaldırılmıştır. Servisi kapatıp açsan bile yakın zamanda işlenen satırlar kısa süreli olarak hatırlanır.
...
## v2.4 tekrar sohbet / çift mesaj / takılma düzeltmesi

- Aynı sohbet için gönder düğmesine yalnızca **bir kez** basılır; doğrulama gecikirse aynı mesaj tekrar gönderilmez.
- İşlenen öneri satırları 6 saat hatırlanır; erişilebilirlik servisini kapatıp açmak aynı satıra hemen geri dönmez.
- İsim bazlı 3,5 saniyelik kilit kaldırıldı; yeni sohbette elle kaydırma bekleme sorunu giderildi.
- Sohbet geçişinden sonra ek kontrollü taramalar yapılır; Flutter event kaçırsa bile akış devam eder.
- Manuel ONAYLA arayüzü ve Tam Otomatik aç/kapa kutusu kaldırıldı; servis açıksa doğrudan tam otomatik çalışır.
